...
.. only:: esp32s3
    ...
    .. note::
        ...
        WakeNet10 三通道默认检测模式为 ``DET_MODE_3CH_90``。单核 CPU 占用：22.6%。
...
.. only:: esp32p4
    ...
    .. note::
        ...
        WakeNet10 三通道默认检测模式为 ``DET_MODE_3CH_90``。单核 CPU 占用：14.1%。
...
.. only:: esp32s31
    ...
    .. note::
        ...
        WakeNet10 三通道默认检测模式为 ``DET_MODE_3CH_90``。单核 CPU 占用：19.9%。
